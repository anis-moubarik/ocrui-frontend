define([],function () {
    ...
    var skokbd = [
        ...
        "J", "j", "K", "k",	"Ǩ", "ǩ", "L", "l", "Ļ","ļ", "M", "m", "N", "n", "Ŋ", "ŋ", "O", "o",
        "Õ", "õ", "P", "p",	"R", "r", "S", "s",	"Š", "š", "S̷", "s̷", "T", "t", "З", "з",  "U", "u", "V", "v",
        "Z", "z", "Ž", "ž", "Ƶ", "ƶ", "Å", "å", "Ä", "ä", "ʹ", "Ә", "ә", "Є", "є", "Ь", "ь", "Ņ", "ņ"вв
    ];
    ...
    var udmkbd = [
        "А", "Б", "В", "Г", "Д", "Е", "Ё", "Ж", "З", "Ӟ", "И", "Ӥ", "Й", "К", "Л", "М", "Н", "Ӈ", "О", "Ӧ", "П", "Р", "С", "Т", "У", "Ф", "Х", "Ц", "Ч", "Ӵ", "Ш", "Щ", "Ъ", "Ы", "Ь", "Э", "Ә", "Ю", "Я",
        "а", "б", "в", "г", "д", "е", "ё", "ж", "з", "ӟ", "и", "ӥ", "й", "к", "л", "м", "н", "ӈ", "о", "ӧ", "п", "р", "с", "т", "у", "ф", "х", "ц", "ч", "ӵ", "ш", "щ", "ъ", "ы", "ь", "э", "ә", "ю", "я"
    ];
