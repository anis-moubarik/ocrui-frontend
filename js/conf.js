define([],function () {
    ...
    var smjkbd = latinkbd.concat([
        "Á", "á", "Å", "å", "Ń", "ń", "Ä", "ä", "Æ", "æ"      
    ]);
    
    var smekbd = latinkbd.concat([
        "Á","á","Č","č","Đ","đ","Ŋ","ŋ","Š","š","Ŧ","ŧ","Ž","ž"
    ]);
    
    var smnkbd = latinkbd.concat([
       "Á","á","Â","â","Ä","ä","Č","č","Đ","đ","Š","š","Ž","ž" 
    ]);
    
    var sjdkbd = latinkbd.concat([
        "B̦", "ʙ̦", "C̦", "c̦", "C̵", "c̵", "C̵̦", "c̵̦", "C̵", "c̵", "C̵̦", "c̵̦", "Ḑ", "ḑ", "Ʒ", "ʒ", "Ʒ̦", "ʒ̒" "З", "з", "E", "e", "Ə", "ə", 
        "F̦", "f̦", "Ģ", "ģ", "H̦", "h̦", "Ь", "ь", "Ķ", "ķ", "Ļ", "ļ", "M̦", "m̦", "Ņ", "ņ", "Ŋ", "ŋ", "Ŋ̒", "ŋ̒", "P̦", "p̒", 
        "Ŗ", "ŗ", "Ș", "ș", "V̦", "v̦", "X̦", "x̦", "Z̦", "z̦", "Ƶ", "ƶ", "Ƶ̦", "ƶ̦", "Ꞩ", "ꞩ"    
    ]);
    
    var smskbd = latinkbd.concat([
        "Â","â","Č","č","Ʒ","ʒ","Ǯ","ǯ","Đ","đ","Ǧ","ǧ","Ǥ","ǥ","Ǩ","ǩ","Ŋ","ŋ","Õ","õ","Š","š","Ž","ž","Å","å","Ä","ä" 
    ]);
    
    var kpvkbd = ["А","а","Б","б","В","в","Г","г","Д","д","Е","е","Ё","ё","Ж","ж","З","з","И","и","І","і","Й","й","К","к","Л","л","М","м","Н","н","О","о","Ӧ","ӧ","П","п","Р","р","С","с","Т","т","У","у","Ф","ф","Х","х","Ц","ц","Ч","ч","Ш","ш","Щ","щ","Ъ","ъ","Ы","ы","Ь","ь","Э","э","Ю","ю","Я","я","Ө","ө","Ӱ","ӱ","д","ж","д","ч","т","ш"];
    
    var koikbd = ["А","а","Б","б","В","в","Г","г","Д","д","Е","е","Ё","ё","Ж","ж","З","з","И","и","І","і","Й","й","К","к","Л","л","М","м","Н","н","О","о","Ӧ","ӧ","П","п","Р","р","С","с","Т","т","У","у","Ф","ф","Х","х","Ц","ц","Ч","ч","Ш","ш","Щ","щ","Ъ","ъ","Ы","ы","Ь","ь","Э","э","Ю","ю","Я","я","Ө","ө","Ӱ","ӱ","д","ж","д","ч","т","ш"];
    
    var komkbd = latinkbd.concat([
        "Ҫ","ҫ","В","в","З","з","Ʒ","ʒ","Ƶ","ƶ","Ә","ә","Ⱬ","ⱬ","Ҭ","ҭ", "Ꞑ", "ꞑ"
    ]);
    
    var komokbd = ["А","а","Б","б","В","в","Г","г","Ԁ","ԁ","Ԃ","ԃ","Е","е","Ж","ж","Җ","җ","З","з","Ԅ","ԅ","Ԇ","ԇ","І","і","Ј","ј","К","к","Л","л","Ԉ","ԉ","М","м","Н","н","Ԋ","ԋ","О","о","Ӧ","ӧ","П","п","Р","р","С","с","Ԍ","ԍ","Т","т","Ԏ","ԏ","У","у","Ч","ч","Ш","ш","Щ","щ","Ы","ы"];
